...
const Boletim = ({ navigation, route }) => {
    
    const object = route.params.userData;
    ...
    return (
        <View style={styles.container}>
            ...
            <Button title="Ver Perfil" color="blue" onPress={() => navigation.navigate('Perfil', { object })} />
            <Button title="Voltar para Home" color="red" onPress={() => navigation.goBack()} />
            </View>
        </View>
    );
};
...
const styles = StyleSheet.create({
    container: {
        ...
        padding: 20,
        paddingTop: 50, // Espaçamento adicional no topo
    },
    title: {
        fontSize: 24,
        fontWeight: 'bold',
    ...
    button: {
        width: '80%',
        marginTop: 20, // Espaçamento adicional no topo
    }
});
